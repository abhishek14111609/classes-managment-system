...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-5 pb-2">
            <div>
                <h3 class="fw-bold mb-1 text-gradient">Add New Item</h3>
                <p class="text-muted small mb-0">Define kit details, pricing, and initial stock levels.</p>
            </div>
            ...
            <div class="col-md-8">
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                    <div class="card-body p-4 p-md-5">
                        <form action="{{ route('school.inventory.items.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="name"
                                        ...
                                        placeholder="e.g. Pro Cricket Kit - Level 1" required>
                                </div>
                                ...
                                <!-- Stock Qty -->
                                <div class="col-md-6">
                                    <label class="form-label fw-bold small text-muted text-uppercase mb-2">Initial Stock
                                        Quantity</label>
                                    <input type="number" name="stock_quantity"
                                        class="form-control rounded-pill px-4 py-2 border-light bg-light" value="0"
                                        required>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="alert_quantity"
                                        class="form-control rounded-pill px-4 py-2 border-light bg-light" value="5"
                                        required>
                                </div>
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="form-check form-switch p-0 d-flex align-items-center">
                                        <input class="form-check-input ms-0 me-3" type="checkbox" name="status" value="1"
                                            checked id="statusSwitch" style="width: 2.5rem; height: 1.25rem;">
